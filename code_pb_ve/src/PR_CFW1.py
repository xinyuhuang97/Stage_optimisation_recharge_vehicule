...
class Frank_Wolfe_Reduced_standard:
    def __init__(self,my_instance):
        self.instance=my_instance
        self.algo_name="PR_CFW1"
    ...
    def save_data(self, df, n_pre, n_iteration):
        ...
        filename="../result/pb_reduced/" + "/"+instance_name+"/" + "PR_CFW1_"+ str(n_pre) + "_" + str(n_iteration) + "_" + time.strftime("%Y%m%d-%H%M%S") + ".json"
