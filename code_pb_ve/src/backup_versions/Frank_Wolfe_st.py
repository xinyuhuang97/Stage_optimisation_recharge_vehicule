...
class Frank_Wolfe_Standard:
    ...
    def FW_st_solve(self, actual_time, verbose=False, analyse=False, K=100, nk=50, n_pre=20):
        """!!! gap primal-duale"""
        data=self.data
...
#changer le pb (supprrimer les deux termes beta_min et beta_max )
#Mettre au propre le calcul y_t_inf y_t_sup (on optimise les variables continues de service)
