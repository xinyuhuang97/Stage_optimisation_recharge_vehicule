...
class Frank_Wolfe_Standard_v2:
    ...
    def FW_st_solve(self, actual_time, verbose=False, analyse=False, K=100, nk=50, n_pre=20, gap_calculate=False, optimize=True,nb_spb=1, active_criterion = "iterations", max_time=3600):
        """!!! gap primal-duale"""
        data=self.data
        # Initialisation
        df=0
